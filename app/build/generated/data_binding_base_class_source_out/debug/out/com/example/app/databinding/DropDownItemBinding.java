...
public final class DropDownItemBinding implements ViewBinding {
  ...
  private DropDownItemBinding(@NonNull TextView rootView, @NonNull TextView textView20) {
  ...
  public static DropDownItemBinding bind(@NonNull View rootView) {
    ...
    TextView textView20 = (TextView) rootView;

    return new DropDownItemBinding((TextView) rootView, textView20);
  }
}
